...
2. If the dispatch prompt includes `## Prepared Context` — trust it. Review the listed existing assets before starting.
   If there is no Prepared Context — read the task file and audit existing art from Context links.
